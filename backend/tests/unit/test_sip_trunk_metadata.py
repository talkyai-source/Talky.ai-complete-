...
@pytest.mark.parametrize(
    "value",
    ["+442046132300", "150001 -> +4420", "+12", "0001234567", 150001, None],
)
def test_trunk_metadata_cannot_claim_an_inbound_did_mapping(value):
    with pytest.raises(ValueError, match="assignment-owned"):

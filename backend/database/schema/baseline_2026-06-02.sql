...
-- from this pg_dump baseline (the table was never applied to prod when the
-- dump was taken, so item-4 froze the gap). Restored here so fresh installs +
-- CI get it. Source: database/migrations/_archive/20260425_add_tenant_ai_credentials.sql
-- =============================================================================
-- =============================================================================

...
Status note:
1. This document is retained as historical architecture context.
2. Active execution authority is now `telephony/docs/phase_3/19_talk_lee_frozen_integration_plan.md`.
3. Current progress tracking is `telephony/docs/phase_3/20_status_against_frozen_talk_lee_plan.md`.

...
function ConnectorsTypedCallbackInner({ providerType }: { providerType: string }) {
    const searchParams = useSearchParams();
    const [canClose, setCanClose] = useState(true);

    const parsed = useMemo(() => parseConnectorsCallback(new URLSearchParams(searchParams.toString()), providerType), [providerType, searchParams]);
...
export default function ConnectorsTypedCallbackPage() {
    ...
    return (
        ...
        >
            <ConnectorsTypedCallbackInner providerType={providerType} />
        </Suspense>
    );
}

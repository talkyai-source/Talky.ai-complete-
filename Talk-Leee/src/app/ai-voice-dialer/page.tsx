...
export const metadata: Metadata = {
  title: "Talk-Lee AI | Advanced AI Voice Dialer for Businesses",
  description:
    "Automate calls, emails, and workflows with Talk-Lee AI. Human-like voice agents boost conversions, save time, and scale communication effortlessly.",
};
      ...
      <div className="mx-auto w-full max-w-6xl px-4 md:px-6 lg:px-8 py-16 md:py-20">
        <header className="text-center">
          ...
          <p className="mt-4 text-base sm:text-lg md:text-xl text-gray-700 dark:text-muted-foreground">
            Turn Every Call and Email Into a Revenue Opportunity With Talk-Lee AI.
          </p>
          <p className="mt-6 text-sm sm:text-base md:text-lg text-gray-700 dark:text-muted-foreground leading-relaxed max-w-4xl mx-auto">
            Talk-Lee AI is an advanced AI Voice Dialer platform built to automate calls, emails, and routine workflows using intelligent
          ...
          <p className="mt-4 text-sm sm:text-base md:text-lg text-gray-700 dark:text-muted-foreground leading-relaxed max-w-4xl mx-auto">
            From inbound call handling to outbound dialing and automated email follow-ups, Talk-Lee AI ensures no opportunity is missed.
          </p>
        </header>

        <section className="mt-14">
          <h2 className="text-2xl md:text-3xl font-semibold text-primary dark:text-foreground">What Makes Talk-Lee AI Different?</h2>
          <p className="mt-4 text-sm sm:text-base md:text-lg text-gray-700 dark:text-muted-foreground leading-relaxed">
            Talk-Lee AI goes beyond traditional auto-dialers. It listens, understands intent, and responds in real time using
        ...
        <section className="mt-14">
          ...
          <p className="mt-4 text-sm sm:text-base md:text-lg text-gray-700 dark:text-muted-foreground leading-relaxed">
            Talk-Lee AI Voice Agents act as virtual call representatives available 24/7. They manage conversations smoothly while
        ...
        <section className="mt-14">
          ...
          <p className="mt-4 text-sm sm:text-base md:text-lg text-gray-700 dark:text-muted-foreground leading-relaxed">
            Talk-Lee AI enables intelligent outbound dialing to reach leads and customers efficiently.
          </p>
          <div className={`mt-8 ${accentCardClassName}`} style={accentCardStyle}>
        ...
        <section className="mt-14">
          ...
          <p className="mt-4 text-sm sm:text-base md:text-lg text-gray-700 dark:text-muted-foreground leading-relaxed">
            Talk-Lee AI seamlessly connects voice interactions with automated email workflows.
          </p>
          <div className={`mt-8 ${accentCardClassName}`} style={accentCardStyle}>
        ...
        <section className="mt-14">
          ...
          <p className="mt-4 text-sm sm:text-base md:text-lg text-gray-700 dark:text-muted-foreground leading-relaxed">
            Talk-Lee AI Assistant Agents work silently in the background to support operations and data accuracy.
          </p>
          <div className={`mt-8 ${accentCardClassName}`} style={accentCardStyle}>
        ...
        <section className="mt-14">
          ...
          <p className="mt-4 text-sm sm:text-base md:text-lg text-gray-700 dark:text-muted-foreground leading-relaxed">
            Every interaction through Talk-Lee AI is captured and organized for easy analysis.
          </p>
          <div className={`mt-8 ${accentCardClassName}`} style={accentCardStyle}>
        ...
        <section className="mt-14">
          <h2 className="text-2xl md:text-3xl font-semibold text-primary dark:text-foreground">Business Benefits of Talk-Lee AI</h2>
          <div className={`mt-8 ${accentCardClassName}`} style={accentCardStyle}>
          ...
          <p className="mt-4 text-sm sm:text-base md:text-lg text-gray-700 dark:text-muted-foreground leading-relaxed">
            Talk-Lee AI enables growth without operational complexity.
          </p>
        </section>
        ...
        <section className="mt-14">
          ...
          <p className="mt-4 text-sm sm:text-base md:text-lg text-gray-700 dark:text-muted-foreground leading-relaxed">
            Talk-Lee AI integrates easily with your existing phone numbers, CRM, and email platforms. Configuration is quick, and
        ...
        <section className="mt-14">
          ...
          >
            <h2 className="text-2xl md:text-3xl font-semibold text-primary dark:text-foreground">
              Power Every Conversation with Talk-Lee AI
            </h2>
            <p className="mt-4 text-sm sm:text-base md:text-lg text-gray-700 dark:text-muted-foreground leading-relaxed max-w-3xl mx-auto">
              Talk-Lee AI brings together AI Voice Dialing, Voice Agents, Email Automation, and Assistant Agents in one unified
